...
def create_lambda_role(iam, account_id, bucket_name):
    ...
    # Trust policy — Lambda and Bedrock Agents can assume this role
    trust = {
        "Version": "2012-10-17",
        "Statement": [
            {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Action": [
                    ...
                    "bedrock:GetAgentAlias", "bedrock:ApplyGuardrail",
...
def main():
    ...
    # 1. S3 bucket
    bucket_name = env.get("SIGMA_S3_BUCKET", "sigma-datatech-apex-123")
