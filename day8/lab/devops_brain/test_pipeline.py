...
def test_null_transaction_id_filtered():
    """Guards against null transaction_ids reaching silver layer."""
...
def test_duplicate_transaction_id_deduplicated():
    """Guards against duplicate transaction_ids in silver layer."""
...
def test_unique_customer_count_per_date():
    ...
    silver_rows = [{"transaction_date": "2024-01-15", "customer_id": "C001", "merchant_id": "M001"}, {"transaction_date": "2024-01-15", "customer_id": "C002", "merchant_id": "M001"}]
